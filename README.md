...
### Первый запуск (macOS)
Так как бинарный файл не имеет цифровой подписи Apple, при первом запуске система может его заблокировать. Чтобы разрешить запуск, выполните команду в терминале:
